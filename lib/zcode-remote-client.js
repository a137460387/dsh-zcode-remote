...
export class ZcodeRemoteClient {
   ...
   *   the model selection the new task starts with. The desktop silently
   *   replaces invalid values with its own defaults, so the subscription
   *   snapshot's `config`, not this payload, is the authority on what applied.
